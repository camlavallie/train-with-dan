...
const upcomingEvents: EventItem[] = [
  {
    ...
    startsAt: '2026-05-08T08:00:00-05:00',
    endsAt: '2026-05-09T23:00:00-05:00',
    schedule: [
      { day: 'Friday, May 8', items: defaultFridaySchedule },
      { day: 'Saturday, May 9', items: defaultSaturdaySchedule },
    ],
  },
  {
    city: 'Adel, GA',
    ...
    schedule: [
      { day: 'Friday, June 26', items: defaultFridaySchedule },
      { day: 'Saturday, June 27', items: defaultSaturdaySchedule },
    ],
  },
  {
    city: 'Sioux Falls, SD',
  ...
  },
  {
    ...
    status: 'Open Registration',
    startsAt: '2026-09-11T08:00:00-05:00',
    endsAt: '2026-09-12T23:00:00-05:00',
    schedule: [
      { day: 'Friday, Sep 11', items: defaultFridaySchedule },
      { day: 'Saturday, Sep 12', items: defaultSaturdaySchedule },
    ],
  },
]
...
const getActiveEvent = () => {
  ...
  return (
    upcomingEvents
      ...
      )[0] ?? upcomingEvents[upcomingEvents.length - 1]
  )
}
    ...
    <main className="bg-black text-white">
        ...
        <div className="relative mx-auto flex min-h-[92svh] max-w-7xl items-center justify-center px-6 pb-16 pt-28 sm:px-8 lg:px-12">
          <div className="max-w-5xl text-center">
            <p className="text-[11px] font-semibold uppercase tracking-[0.35em] text-amber-300/90 sm:text-xs">
              {activeEvent.city} • Two-Day Training Event
            </p>
            ...
            <p className="mx-auto mt-6 max-w-3xl text-base leading-7 text-white/75 sm:text-lg sm:leading-8 lg:text-xl">
              ...
              Join us in {activeEvent.city} for a weekend of worship, identity,
              practical teaching, and activation for everyday life with Jesus.
            </p>
        ...
        <div className="mx-auto max-w-7xl px-6 py-16 sm:px-8 lg:px-12">
          <div className="mx-auto max-w-4xl text-center">
            <p className="text-sm font-semibold uppercase tracking-[0.3em] text-amber-300/90">
              {activeEvent.date} • {activeEvent.city}
            </p>
        ...
        <div className="grid items-center gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:gap-16">
          ...
          <div>
            ...
            <div className="mt-8 space-y-5 text-base leading-7 text-white/72 sm:text-lg sm:leading-8">
              ...
              <p>
                Join us at {activeEvent.venue} in {activeEvent.city} on{' '}
                {activeEvent.date}.
              </p>
              <p>
      ...
      <section className="mx-auto max-w-7xl px-6 py-20 sm:px-8 lg:px-12 lg:py-24">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-base leading-7 text-white/70 sm:text-lg sm:leading-8 lg:text-xl">
            A simple rhythm of worship, teaching, and response across two days
            in {activeEvent.city}.
          </p>
        </div>

        <div className="mt-14 grid gap-6 lg:grid-cols-2">
          {activeEvent.schedule.map((group) => (
            <div
              key={group.day}
      ...
      >
        ...
        <p className="mx-auto mt-6 max-w-3xl text-base leading-7 text-white/72 sm:text-lg sm:leading-8">
          Make plans to be in the room at {activeEvent.venue} for{' '}
          {activeEvent.date}, centered on identity, freedom, worship, and
          practical equipping.
        </p>
